...
public class PaymentUpdate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			boolean isUpdated = PaymentDbUtil.updatePayment(paymentId, studentId, paymentAmount, paymentDate,
					paymentMethod, paymentStatus, receiptNumber, paymentReference, paymentNotes);
